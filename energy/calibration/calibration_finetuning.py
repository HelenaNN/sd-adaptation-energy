...
BASE_OUTPUT_DIR = Path("calibration_outputs/finetuning")
GLOBAL_GPU_METRICS = BASE_OUTPUT_DIR / "global_gpu_metrics_calibration_finetuning.csv"

# Optional: pin specific GPU ID
GPU_DEVICE_ID = None
...
for i, (dataset_name, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_calibration_finetuning_res{RESOLUTION}_{dataset_name}_steps{MAX_TRAIN_STEPS}_seed{SEED}"
    ...
    command = [
        "accelerate", "launch", "train_text_to_image_codecarbon.py",
