...
BASE_OUTPUT_DIR = Path("/mnt/rhome/hnn/calibration_cp/sdv15/finetuning/calibration_titan")
GLOBAL_GPU_METRICS = BASE_OUTPUT_DIR / "global_gpu_metrics_calibration_titan.csv"
...
for i, (dataset_name, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_calibration_finetuning_titan_res{RESOLUTION}_{dataset_name}_steps{MAX_TRAIN_STEPS}_seed{SEED}"
