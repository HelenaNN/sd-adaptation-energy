...
BASE_OUTPUT_DIR = Path("/mnt/rhome/hnn/calibration_cp/sdv15/textual_inversion/calibration_titan")
...
for i, (dataset_name, placeholder_token, initializer_token, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_calibration_ti_titan_res{RESOLUTION}_{dataset_name}_steps{MAX_TRAIN_STEPS}_seed{SEED}"
