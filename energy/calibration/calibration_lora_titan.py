...
BASE_OUTPUT_DIR = Path("/mnt/rhome/hnn/calibration_cp/sdv15/lora/calibration_titan")
...
SEED = 1337
LEARNING_RATE = "1e-04"
COOLDOWN_SECONDS = 0  # sin cooldown, son entrenamientos cortos
...
for i, (dataset_name, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_calibration_lora_titan_res{RESOLUTION}_{dataset_name}_steps{MAX_TRAIN_STEPS}_seed{SEED}"
