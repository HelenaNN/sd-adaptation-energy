...
BASE_OUTPUT_DIR = Path("calibration_outputs/textual_inversion")
GLOBAL_GPU_METRICS = BASE_OUTPUT_DIR / "global_gpu_metrics_calibration_ti.csv"
...
EXPERIMENTS = [
    ("dataset_sample", "<custom-style>", "art", "A drawing of a tower."),
    ("dataset_sample", "<custom-style>", "art", "A drawing of a tower."),
    ("dataset_sample", "<custom-style>", "art", "A drawing of a tower."),
]
...
for i, (dataset_name, placeholder_token, initializer_token, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_calibration_ti_res{RESOLUTION}_{dataset_name}_steps{MAX_TRAIN_STEPS}_seed{SEED}"
