...
BASE_OUTPUT_DIR = Path("/mnt/rhome/hnn/experiments/sdv15/finetuning/outputs_titan_outputs_with_cp")
GLOBAL_GPU_METRICS = BASE_OUTPUT_DIR / "global_gpu_metrics_titan_with_cp.csv"
...
for i, (dataset_name, max_train_steps, validation_prompt) in enumerate(EXPERIMENTS):
    ...
    exp_name = f"{i}_sdv15_finetuning_res{RESOLUTION}_{dataset_name}_steps{max_train_steps}_seed{SEED}"
